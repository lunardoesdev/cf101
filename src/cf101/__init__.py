...
warp-common: &warp-common
  ...
  # ports possible: 500, 854, 859, 864, 878, 880, 890, 891, 894, 903, 908, 928, 934, 939, 942, 943, 945, 946, 955, 968, 987, 988, 1002, 1010, 1014, 1018, 1070, 1074, 1180, 1387, 1701, 1843, 2371, 2408, 2506, 3138, 3476, 3581, 3854, 4177, 4198, 4233, 4500, 5279, 5956, 7103, 7152, 7156, 7281, 7559, 8319, 8742, 8854, 8886
  port: 5279
...
warp-fi1-common: &warp-fi1-common
  <<: *warp-common
  server: fi1.tribukvy.ltd

awg1-config-common: &awg1-config-common
  jc: 4
  jmin: 40
  jmax: 70
  s1: 0
...
awg1-config-type1: &awg1-config-type1
...
awg1-config-type2: &awg1-config-type2
...
awg1-config-type3: &awg1-config-type3
...
awg1-config-type4: &awg1-config-type4
